...
export default function CreatePage() {
  ...
  const uploadAndCreatePost = async (file: File) => {
    ...
    // 4. Crear post en tabla posts_new
      ...
      */}
      ...
      <main className="max-w-lg mx-auto px-4 py-8">
        ...
        <div className="flex flex-col gap-2">
          {imagePreview ? (
            <div className="relative aspect-suare w-full rounded-xl overflow-hidden bg-card-bg border border-border">
              <Image
                src={imagePreview}
